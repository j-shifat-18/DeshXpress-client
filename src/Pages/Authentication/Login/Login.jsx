    ...
    <div className="card text-black  w-full max-w-md shrink-0 ">
      <div className="card-body">
        ...
        <form className="fieldset" onSubmit={handleSubmit(handleLogin)}>
          ...
          />
          {
            errors.email?.type === 'required' && <p className="text-red-500 text-base">Please enter your Email .</p>
          }
          {
            errors.email?.type === 'pattern' && <p className="text-red-500 text-base">Please enter a valid Email .</p>
          }
